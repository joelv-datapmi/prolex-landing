...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Absolutely. All data is encrypted at rest and in transit. We follow industry-standard security practices and are compliant with applicable data protection regulations.",
    },
    {
        question: "What happens after my trial ends?",
        answer:
            "After your 14-day free trial, you'll be prompted to choose a paid plan to continue. Your data will be retained for 30 days if you choose not to upgrade.",
    },
    {
        question: "Is Prolex AI have AI features?",
        answer:
            "Yes. Prolex AI includes AI-powered document drafting, clause suggestions, case summarisation, and smart deadline recommendations — available on Premium and above.",
    },
]
        ...
        <section className="bg-[#f7f7f8] py-24 px-6">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex flex-col gap-3">
                    {faqs.map((faq, i) => (
                        <ScrollReveal key={faq.question} delay={i * 0.07}>
                            <FAQItem {...faq} />
                        </ScrollReveal>
                    ))}
                </div>
